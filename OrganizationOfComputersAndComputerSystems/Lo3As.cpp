...
int Lo3As()
{
	...
	cout << "Лабораторная работа №3. Выполнил студент Аверкина Виктория группы 6104 Варисант 91" << endl << "В одномерном массиве A = { a[i] } целых чисел вычислить количество ненулевых элементов с нечетными номерами." << endl;
	int len;
